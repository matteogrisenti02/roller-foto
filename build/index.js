    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.MediaUploadCheck, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.MediaUpload, {
        ...
        render: ({
          ...
          onClick: open,
          variant: "primary",
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Seleziona immagini', 'roller-foto')
        })
      })
    }), images && images.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
      className: "roller-preview",
      children: images.split(',').map((src, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("img", {
        src: src,
        alt: "",
        style: {
          width: '100px',
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/roller-foto","version":"1.0.0","title":"Roller Foto","category":"widgets","description":"Simpler Roller of Images","example":{},"attributes":{"images":{"type":"string","default":""},"fallbackCurrentYear":{"type":"string"},"showStartingYear":{"type":"boolean"},"startingYear":{"type":"string"}},"supports":{"color":{"background":false,"text":true},"html":false,"typography":{"fontSize":true}},"textdomain":"roller-foto","editorScript":"file:./index.js","viewScript":"file:./view.js","render":"file:./render.php"}');
